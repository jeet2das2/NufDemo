...
ele1.click()
sleep(1)
driver.find_element_by_name("departure").send_keys("DEL")
sleep(1)
driver.find_element_by_name("arrival").send_keys("DOH")
sleep(1)
...
driver.find_element_by_xpath("(//div[@class='airline-filter'])[2]").click()
