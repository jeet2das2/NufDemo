...
for i in range(1, 13):
    ...
    if curr_mnth == "January 2023":
        driver.find_element_by_xpath("//div[@class='react-datepicker__day react-datepicker__day--020']").click()
        break
    else:
...
# -----------------------------------------------------------------------------------------------------------
# OrderReshop
driver.find_element_by_xpath("//button[text()='Manage journey']").click()
sima1 = WebDriverWait(driver, 100).until(
            EC.invisibility_of_element_located((By.XPATH, "//div[@class='loader-logo']")))
driver.find_element_by_xpath("(//i[text()='keyboard_arrow_right'])[1]").click()
driver.find_element_by_xpath("(//i[text()='keyboard_arrow_right'])[1]").click()
driver.find_element_by_xpath("(//i[text()='keyboard_arrow_right'])[1]").click()
driver.find_element_by_xpath("(//i[text()='keyboard_arrow_right'])[1]").click()
driver.find_element_by_xpath("(//i[text()='keyboard_arrow_right'])[2]").click()
sima2 = WebDriverWait(driver, 100).until(
            EC.invisibility_of_element_located((By.XPATH, "//div[@class='loader-logo']")))
driver.find_element_by_xpath("(//div[@class='flight-card'])[2]").click()
sima3 = WebDriverWait(driver, 100).until(
            EC.invisibility_of_element_located((By.XPATH, "//div[@class='loader-logo']")))
driver.find_element_by_xpath("//button[text()='Continue']").click()
sima4 = WebDriverWait(driver, 100).until(
            EC.invisibility_of_element_located((By.XPATH, "//div[@class='loader-logo']")))
driver.find_element_by_xpath("//button[text()='Proceed & Confirm']").click()
